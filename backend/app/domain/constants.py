...
CANONICAL_COMMODITIES: Final[FrozenSet[str]] = frozenset({COMMODITY_THERMAL_COAL, COMMODITY_COKING_COAL})
...
CANONICAL_VESSEL_CLASSES: Final[FrozenSet[str]] = frozenset({
    VESSEL_CLASS_HANDYSIZE, VESSEL_CLASS_SUPRAMAX, VESSEL_CLASS_ULTRAMAX,
    VESSEL_CLASS_PANAMAX, VESSEL_CLASS_KAMSARMAX, VESSEL_CLASS_CAPESIZE,
})
